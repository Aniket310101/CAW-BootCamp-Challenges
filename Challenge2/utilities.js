...
const updateQuantityToDecrease = (addButtonClicked, element, itemPrice) => {
    ...
    if (quantity - 1 === 0) {
        ...
        element.childNodes[0].childNodes[1].textContent =
            parseInt(quantity) - 1;
        element.childNodes[2].childNodes[1].textContent =
            parseInt(quantity) - 1;
    }
...
const saveItemDetails = (parentElement) => {
    return {
        ...
        itemImage:
            parentElement.previousSibling.previousSibling.childNodes[1].src,
    };
};
