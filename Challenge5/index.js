...
episodes.forEach((episode) => {
    ...
    const newListDiv = createListDiv(parentElement);

    const newLabelField = createLabelField(newListDiv, episode);

    createInputField(newLabelField, episode);

    const newSpanField = createSpanField(newLabelField);

    createNodeSpanText(newSpanField, episode);
});
